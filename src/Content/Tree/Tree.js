...
import "./Tree.css";
import { Legend, LegendLink } from "../Legend/Legend";
...
const width = 832,
  ...
  linkWidth = d3.scaleLog().domain([1, 6000]).range([1, 12]).clamp(true),
  node_radius = 6,
  node_levels = 4,
...
class Tree extends Component {
  ...
  render() {
    return (
      <div>
        <div>
          <h3 className="heading">Hierarchical Tree </h3>
        ...
        <div className="legendLink">
          <LegendLink linkWidth={linkWidth} />
        </div>
